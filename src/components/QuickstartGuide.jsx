          ...
          <div className="max-w-5xl mx-auto p-6 sm:p-8">
            ...
            >
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8 mb-8">
                <div>
                  ...
                  <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl" style={{ fontFamily: "'Montserrat', sans-serif" }}>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 mb-8 border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <code className="block p-2 bg-gray-100 text-gray-800 rounded text-sm font-mono">
                      api_key
                    </code>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                <h2 className="text-xl font-bold text-gray-900 mb-4">Five simple steps</h2>
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Add the SDK</h2>
                  ...
                  <div className="space-y-6">
                    <div className="bg-green-50 border border-green-100 rounded-lg p-4" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                      ...
                      <ol className="list-decimal list-inside text-gray-700 space-y-2">
                        ...
                        <li>We send <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">agreement.created</code> webhook to your server</li>
                      </ol>
                    </div>
                    
                    <div className="rounded-lg overflow-hidden border border-gray-200">
                      <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                        <div className="text-sm font-mono text-gray-600">Including the Script</div>
                      </div>
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Database Schema</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>
                          Add a new <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">payment_method</code> type:
                          <code className="ml-1 bg-gray-100 px-1 py-0.5 rounded text-sm">type: 'housetabz'</code>
                        </li>
                        <li>Create a new table: <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">housetabz_agreements</code></li>
                      </ul>
                    </div>
                    
                    <div className="rounded-lg overflow-hidden border border-gray-200">
                      <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                        <div className="text-sm font-mono text-gray-600">housetabz_agreements Schema</div>
                      </div>
                      <div className="bg-gray-50 p-4">
                        <pre className="text-sm overflow-x-auto">
                          <code className="text-gray-800 font-mono">
{`{
  ...
  updated_at: timestamp
                  ...
                  {/* <div className="mt-6">
                    <a 
                      href="#data-model-details" 
                      className="inline-flex items-center text-sm font-medium hover:text-green-700"
                      style={{ color: '#34d399' }}
                    >
                      View full data model
                      <ChevronRight className="ml-1 w-4 h-4" />
                    </a>
                  </div> */}
                </div>
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Setup Webhooks</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-4">
                      <div className="bg-purple-50 border border-purple-100 rounded-lg p-4">
                        ...
                        <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                          ...
                          <li>Create a <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">payment_method</code> with <code>'housetabz'</code></li>
                          <li>Create a <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">housetabz_agreement</code> with <code>status: 'pending'</code></li>
                        </ul>
                      </div>

                      <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
                        <h3 className="font-medium text-blue-800 mb-2">👥 User Action</h3>
                        <p className="text-gray-600">Each roommate logs in and accepts responsibility.</p>
                      </div>
                      ...
                      <div className="bg-green-50 border border-green-100 rounded-lg p-4" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                        ...
                        <ul className="list-disc list-inside text-gray-700 ml-4 space-y-1">
                          ...
                          <li>Update <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">housetabz_agreement.status</code> to <code>'active'</code></li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="rounded-lg overflow-hidden border border-gray-200">
                      <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                        <div className="text-sm font-mono text-gray-600">Webhook Endpoint</div>
                      </div>
                      <div className="bg-gray-50 p-4">
                        <pre className="text-sm overflow-x-auto">
                          <code className="text-gray-800 font-mono">
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Share Billing Data</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-amber-50 border border-amber-100 rounded-lg p-4">
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>
                          If <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">payment_method.type === 'housetabz'</code>,
                          send a <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">POST /bills</code> request
                        </li>
                        <li>
                    ...
                    <div className="rounded-lg overflow-hidden border border-gray-200">
                      <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                        <div className="text-sm font-mono text-gray-600">POST /bills Example</div>
                      </div>
                      <div className="bg-gray-50 p-4">
                        <pre className="text-sm overflow-x-auto">
                          <code className="text-gray-800 font-mono">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    <div className="bg-green-50 border border-green-100 rounded-lg p-4" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                      ...
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                        <li>
                          Webhook: <code className="bg-gray-100 px-1 py-0.5 rounded text-sm">bill.paid</code>
                        </li>
                        <li>
                    ...
                    <div className="rounded-lg overflow-hidden border border-gray-200">
                      <div className="bg-gray-100 px-4 py-2 border-b border-gray-200">
                        <div className="text-sm font-mono text-gray-600">bill.paid Payload</div>
                      </div>
                      <div className="bg-gray-50 p-4">
                        <pre className="text-sm overflow-x-auto">
                          <code className="text-gray-800 font-mono">
...
const NavItem = ({ icon, title, isActive, onClick, mobile = false }) => {
  return (
    <li>
      <button
        onClick={onClick}
