          ...
          <div className="max-w-5xl mx-auto p-6 sm:p-8">
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Creating a Webhook Endpoint</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="rounded-lg overflow-hidden border border-gray-200 mb-6">
                    <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                      <div className="text-sm font-mono text-gray-600">Example Webhook Handler (Node.js/Express)</div>
                      <button 
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100 mt-8">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">Registering Your Webhook URL</h2>
                  <p className="text-gray-600 mb-6">
                    After creating your webhook endpoint, you need to register it with HouseTabz to receive events:
                  </p>

                  <ol className="list-decimal list-inside text-gray-600 ml-4 mb-6 space-y-3">
            ...
            >
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">agreement.created Event</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="rounded-lg overflow-hidden border border-gray-200 mb-6">
                    <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                      <div className="text-sm font-mono text-gray-600">agreement.created Event Example</div>
                      <button 
                  ...
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg mb-8">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="py-2 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Field</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">event</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">The type of event ("agreement.created")</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">timestamp</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string (ISO 8601)</td>
                        <td className="py-2 px-4 text-sm text-gray-500">When the event occurred</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">houseTabzAgreementId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string (UUID)</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Unique identifier for the HouseTabz agreement</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">externalAgreementId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string | null</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Optional external reference ID</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">transactionId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Your transaction identifier</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">serviceName</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Name of the service</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">serviceType</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Type of service (e.g., "energy")</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">estimatedAmount</td>
                        <td className="py-2 px-4 text-sm text-gray-500">number</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Estimated monthly payment amount</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">status</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Current status ("pending")</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100 mt-8">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">request.authorized Event</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="rounded-lg overflow-hidden border border-gray-200 mb-6">
                    <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                      <div className="text-sm font-mono text-gray-600">request.authorized Event Example</div>
                      <button 
                  ...
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg mb-8">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">event</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">The type of event ("request.authorized")</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">timestamp</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string (ISO 8601)</td>
                      ...
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">status</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">New status ("authorized")</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">serviceName</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
              ...
              <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100 mt-8">
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-4">bill.paid Event</h2>
                  <p className="text-gray-600 mb-6">
                  ...
                  <div className="rounded-lg overflow-hidden border border-gray-200 mb-6">
                    <div className="bg-gray-100 px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                      <div className="text-sm font-mono text-gray-600">bill.paid Event Example</div>
                      <button 
                  ...
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg mb-8">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">event</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">The type of event ("bill.paid")</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">houseTabzAgreementId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string (UUID)</td>
                        <td className="py-2 px-4 text-sm text-gray-500">The agreement ID associated with this bill</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">externalAgreementId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string | null</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Your reference ID for the agreement (may be null)</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">externalBillId</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string</td>
                        <td className="py-2 px-4 text-sm text-gray-500">Your unique identifier for this bill</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">amountPaid</td>
                        <td className="py-2 px-4 text-sm text-gray-500">number</td>
                        <td className="py-2 px-4 text-sm text-gray-500">The total amount paid for this bill</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-4 text-sm font-mono text-gray-900">paymentDate</td>
                        <td className="py-2 px-4 text-sm text-gray-500">string (ISO 8601)</td>
                        <td className="py-2 px-4 text-sm text-gray-500">When the final payment was processed</td>
                      </tr>
                    </tbody>
                  </table>
