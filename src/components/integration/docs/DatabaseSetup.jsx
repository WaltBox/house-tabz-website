  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50" style={{ fontFamily: "'Montserrat', sans-serif" }}>
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div className="flex lg:hidden items-center space-x-2" style={{ color: '#34d399' }}>
                ...
                <h2 className="font-semibold text-base">Database Setup</h2>
              </div>
      ...
      <div className="hidden lg:flex lg:flex-shrink-0">
        <div className="w-64 bg-white border-r border-gray-200 fixed top-16 h-[calc(100vh-4rem)] overflow-y-auto pt-6">
        ...
        <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 mt-16">
          ...
          >
            <div className="mb-6 lg:mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                Database Setup
              </h1>
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6 border border-gray-100 mb-6 lg:mb-8">
              ...
              <div className="bg-green-50 border border-green-100 rounded-lg p-4 mb-6" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                ...
                <p className="text-xs sm:text-sm text-gray-700">
                  When a customer uses "Pay with HouseTabz", we'll send you an <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.created</code> webhook 
          ...
          >
            <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 mb-8">
              ...
              <div className="p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Add HouseTabz Payment Type</h2>
                ...
                <div className="overflow-x-auto mb-6 sm:mb-8">
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="py-2 px-2 sm:px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Field Name</th>
                        <th className="py-2 px-2 sm:px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b">Update Required</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">type</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">Add 'housetabz' value</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">Add 'housetabz' as a valid payment type alongside your existing types (e.g., 'card', 'bank', etc.)</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <div className="bg-green-50 border border-green-100 rounded-lg p-4 mb-6" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                  ...
                  <p className="text-xs sm:text-sm text-gray-700 mb-4">
                    ...
                    <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm"> agreement.created</code> webhook to satisfy your current payment system including:
                  </p>
                  <ul className="mt-2 space-y-1 text-xs sm:text-sm text-gray-700">
                    <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">paymentMethodId</code>: A unique identifier for this payment method</li>
                    <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">type</code>: Will be 'housetabz'</li>
                    <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">last4</code>: Last 4 digits of the account reference</li>
                    <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">brand</code>: Payment source information</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          >
            <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 mb-8">
              ...
              <div className="p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Create HouseTabz Agreements Table</h2>
                <p className="text-xs sm:text-sm text-gray-600 mb-6">
                  You'll need to create a new <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">housetabz_agreements</code> table in your database 
                ...
                <div className="overflow-x-auto mb-6 sm:mb-8">
                  <table className="min-w-full bg-white border border-gray-200 rounded-lg">
                    ...
                    <tbody className="divide-y divide-gray-200">
                      <tr>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">id</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">UUID/String</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">Primary key (your internal ID)</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">user_id</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">String</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">Your internal user/customer ID</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">housetabz_agreement_id</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">String</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">HouseTabz agreement identifier</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">transaction_id</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">String</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">Your transaction identifier</td>
                      </tr>
                      <tr>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap">payment_method_id</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">String</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">Reference to payment methods table</td>
                      </tr>
                      <tr className="bg-gray-50">
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm font-mono text-gray-900 whitespace-nowrap" style={{ color: '#34d399' }}>status</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500 whitespace-nowrap">String/Enum</td>
                        <td className="py-2 px-2 sm:px-4 text-xs sm:text-sm text-gray-500">'pending', 'active', 'cancelled'</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          >
            <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 mb-8">
              ...
              <div className="p-4 sm:p-6">
                <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-4">Handling HouseTabz Webhooks</h2>
                <p className="text-xs sm:text-sm text-gray-600 mb-6">
                ...
                <div className="space-y-6">
                  <div className="bg-green-50 border border-green-100 rounded-lg p-4 mb-6" style={{ backgroundColor: 'rgba(52, 211, 153, 0.1)', borderColor: 'rgba(52, 211, 153, 0.3)' }}>
                    ...
                    <p className="text-xs sm:text-sm text-gray-700 mb-4">
                      When a customer uses the "Pay with HouseTabz" button, you'll receive an <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.created</code> webhook with all necessary parameters to create a new entry in your database, including:
                    </p>
                    <ul className="mt-2 space-y-1 text-xs sm:text-sm text-gray-700">
                      <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">userId/customerId</code>: Your customer's ID</li>
                      <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">housetabzAgreementId</code>: Unique identifier from HouseTabz</li>
                      <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">transactionId</code>: Your transaction reference</li>
                      <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">status</code>: Initially set to 'pending'</li>
                      <li>• <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">paymentMethodId</code>: Reference to the payment method</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-purple-50 border border-purple-100 rounded-lg p-4 mb-6">
                    ...
                    <ul className="list-disc list-inside text-xs sm:text-sm text-gray-700 ml-4 space-y-1">
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.authorized</code>: Update status to 'active'</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.completed</code>: Update status to 'completed'</li>
                      <li><code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.cancelled</code>: Update status to 'cancelled'</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="rounded-lg p-4 mb-6">
                  ...
                  <p className="text-xs sm:text-sm text-gray-700">
                    When you receive the <code className="bg-gray-100 px-1 py-0.5 rounded text-xs sm:text-sm">agreement.created</code> webhook, you should create both a payment method entry and a HouseTabz agreement entry. This ensures your existing payment system works smoothly with HouseTabz.
                  </p>
                </div>
              </div>
            </div>
